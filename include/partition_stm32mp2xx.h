...
//   <o.12> 12  TAMP_IRQn             Secure state
//   <o.13> 13  RTC_IRQn              Secure state
...
//   <o.11> 171 IPCC1_RX1_IRQn        Secure state
//   <o.12> 172 IPCC1_TX1_IRQn        Secure state
//   <o.13> 173 IPCC1_RX1_S_IRQn      Secure state
//   <o.14> 174 IPCC1_TX1_S_IRQn      Secure state
//   <o.15> 175 IPCC2_RX1_IRQn        Secure state
//   <o.16> 176 IPCC2_TX1_IRQn        Secure state
...
//   <o.7>  199 HSEM_IRQn             Secure state
...
#define SAU_INIT_REGION(n)							\
	do {									\
		...
		SAU->RLAR =  (SAU_INIT_END##n        & SAU_RLAR_LADDR_Msk) |	\
			     ((SAU_INIT_NSC##n << SAU_RLAR_NSC_Pos)		\
			       & SAU_RLAR_NSC_Msk) | 1U				\
	} while (0)

/**
  \brief   Setup a SAU Region
  \details Writes the region information contained in SAU_Region to the registers SAU_RNR, SAU_RBAR, and SAU_RLAR
 */
